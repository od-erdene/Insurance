...
namespace Insurance
{
    public partial class AddDocumentsTypeForm : Form
    {
        public AddDocumentsTypeForm()
        {
            InitializeComponent();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                db = new DB();
                db.cmd.CommandText = "INSERT INTO Documents (DocumentsName) VALUES (@name)";
